...
\eqref{e:bubble}. Indeed, $\sum_j \beta_j$ is a telescoping sum. By
\eqref{e:beta-bd}, the coefficients decay sufficiently rapidly that
\begin{equation}
\sum_{j=1}^\infty \beta_j
	=
{\sf B}_{m^2}.
\end{equation}
\commentbw{I don't think this is quite the right argument.}
...
\begin{rk}
A heuristic argument is as follows: By \eqref{e:beta-bd}, a crude approximation to
the flow of $\gbar$ is the recursion
\begin{equation}
