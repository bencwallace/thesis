...
We note here only the fact that the $\Wcal_j(\Lambda)$ norm dominates the $T_0(\ell_j)$ norm
...
Some steps in this proof continue to hold unchanged whereas others must
be changed. A detailed verification that the proof holds for $s > 0$
is carried out in Chapter~\ref{sec:RGstep}. % \ref{sec:Rpf2} below.
