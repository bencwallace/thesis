...
\frac{1}{m^2}
	+
\frac{1}{m^4} \frac{1}{|\Lambda|} \frac{D^2 Z_N^\zero(0; \1, \1)}{Z_N(0)}.
\end{equation}
\end{prop}
...
\new{The precise definition of the $\Wcal_j$ norm adapated to our current setting
