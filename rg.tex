...
$\Vpt : \Vcalp\to\Vcalc$ is defined so as to maintain the approximate form
\begin{equation}
\label{e:Zapprox}
Z_j \approx e^{-\Vc_j} (1 + W_j^2),
\end{equation}
where $W_j$ is an explicit polynomial that is second-order in $V_j$;
