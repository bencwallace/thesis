...
The $T_\phi$ seminorm controls the values of $F$ and its derivatives (up to order
...
In practice, we set $C = C_j$ and obtain a sequence $\Vpt = V_{\mathrm{pt},j}$ of maps
and $W_j$ of polynomials. By \cite[\eqref{IE-e:W-logwish}]{BS-rg-IE},
\todo{(check this)},
\begin{equation}
\label{e:Wbilinbd}
\|W_j\|_{T_0(\ell_j)}
