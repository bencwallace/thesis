...
\commentbw{(2.4.14): LHS should be $F$ not $F_\varnothing$.  (This inequality is also inconsistent
with your version of (2.4.12) but is correct if you change (2.4.12) to the usual
thing --- in fact is it not an equality rather than an inequality?)}
...
\commentbw{Sec 2.8: you make reference to [9] but this is for $n=0$ yet you seem to
