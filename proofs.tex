...
\commentbw{Right now, most things are in $\Ucal$ but this space
is too big as it includes $\tau_{\nabla\nabla}$}

In order to employ \REF, we fix $\nu_0 = \hat\nu_0^c(m^2, g_0, \gamma_0)$
...
\commentbw{Sketch proof.}

\begin{proof}[Sketch of proof of Theorem~\ref{thm:mr}(ii)]
\todo{I could sketch this.}
\end{proof}

\todo{It is a consequence of the above that}
\begin{equation}
