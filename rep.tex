...
different models. For instance, the Kac-Siegert transformation \REF can be used
to write the partition function of the $O(n)$ model as a partition function for
a perturbation of the $|\varphi|^4$ model. In the other direction, the
...
is a special case of a result of Brydges, Imbrie, and Slade \cite{BIS09}. We
restrict out attention to the discrete torus $\Lambda$. We begin with the necessary
background on Grassmann integration, introduced in \cite{Bere66}. However, we
follow the treatment given in \cite{BIS09}.
