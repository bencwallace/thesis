...
We let $\Ncal^\bulk$ be the algebra of even forms \newer{(i.e.\ differential forms of
even degree)} with sufficiently smooth coefficients
...
% the parameters $g_0, \nu_0, z_0$
\newer{a coordinate capturing the relevant and marginal directions}
