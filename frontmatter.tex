...
The proof employs a renormalisation group method \new{of Bauerschmidt, Brydges, and Slade}
based on a finite-range covariance
decomposition and requires two extensions to this method.

The first extension, which
...
\new{to realize the the two-point function and
susceptibility for the walk with self-attraction as a small perturbation
of the corresponding quantities without self-attraction, whose asymptotic behaviour
was determined by Bauerschmidt, Brydges, and Slade.}
\end{abstract}
...
throughout the course of my studies at UBC. I cannot overstate how much I have benefited
...
fruitful discussions as well as for a lot of helpful advice. In addition, I am grateful
to David Brydges for a number of enlightening and inspiring conversations as well as for
suggesting a wealth of promising research directions. I also thank Maxime Bergeron and
Tom Hutchcroft for helpful comments on Chapter~\ref{sec:intro} of this thesis. I am grateful
towards the UBC probability group as a whole for providing such a stimulating and friendly
research environment.

Lastly, I thank my family and friends for their unwavering support throughout the course
of my studies.
% Gordon Slade
