...
in \cite{Vand98} \newer{and a discussion of some rigorous results can be found in \cite{Holl09}.}
...
\commentbw{$\gamma > \beta$ compare to pure self-attraction (Brydges-Slade, Bolthausen-Schmock, Ooono). $\gamma=\beta$ conjecture by van der Hofstad-Klenke.
$\gamma < \beta$ walk in ball. Theta-curve/two transitions due to tricritical
behaviour.}
