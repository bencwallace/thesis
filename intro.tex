...
model with a new (``renormalised'') interaction.
...
\cite{HT87}.} This thesis concerns the renormalisation group method of Bauerschmidt,
...
\new{Weakly self-avoiding walk on a hierarchical lattice was studied by a renormalisation
...
a \new{new} renormalisation group method.
