...
We begin \new{with} a short discussion of some useful notation and mathematical
background.
...
logarithmic corrections to scaling in this case were identified in \cite{HT87}.}
...
\end{cases}
\end{equation}
\new{This suggests the value $d_c = 4$ of the upper-critical dimension.}
\end{rk}
