...
An important case is when $J$ has $\{0, 1 \}$-valued entries. In this case, $d_x$ is the
...
\todo{First, define Markov process in terms of a matrix $Q$. Then set $Q = A$
(similar to what we do with $P$ below).}
...
% The simple random walk is the case $A = -\Delta$.
...
\todo{Discuss first-order and continuous phase transitions.}
